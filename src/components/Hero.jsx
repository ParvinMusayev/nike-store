    ...
    return (
        <>
            <div className='relative h-auto w-auto flex flex-col'>
                <div className='bg-theme clip-path h-[85vh] lg:h-[75vh] md:h-[65vh] sm:h-[55vh] w-auto absolute top-0 right-0 left-0 z-10 opacity-100'></div>

                <div className='relative z-20 opacity-100 grid justify-center items-center nike-container'>
